...
const UE: SolutionStep = {text: `u`, value: 34};
const UE0_RT: SolutionStep = {text: `u'`, value: 35, class: 'right-thumb'};
const UE0_LIF: SolutionStep = {text: `u'`, value: 35, class: 'left-index-finger'};
...
const Z: SolutionStep = {text: `z`, value: 32};
...
export const SOLUTIONS: SolutionStep[][] = [
    [],
    // F2L
    [S_P, R, S, U0_LIF, S, R0, S, U, C_P, S, Y0, NL, S_P, R0, S, ...U2, S, R, S, U0_RT, S, U0_LIF, CS_P, R0, S, U, S, R, C_P], // 1
    [S_P, U, S, R, S, U0_LIF, S, R0, S, U0_LIF, C_P, S, Y0, NL, S_P, R0, S, U, S, R, C_P], // 2
    ...
    [Y0, S, S_P, R0, S, U0_LIF, S, R, S, U, CS_P, R0, S, U0_LIF, S, R, C_P], // 6
    ...
    [Y0, S, S_P, R0, S, U, S, R, S, U0_LIF, CS_P, R0, S, U, S, R, C_P], // 10
    [S_P, R, S, U, S, R0, S, U0_LIF, CS_P, R, S, U, S, R0, C_P], // 11
    [S_P, R, S, U, S, R0, S, U0_LIF, CS_P, R, S, U, S, R0, S, U0_LIF, CS_P, R, S, U, S, R0, C_P], // 12
    [S_P, R, S, U0_LIF, S, R0, S, U, C_P, S, Y0, S, S_P, R0, S, U, S, R, C_P], // 13
    [Y0, S, S_P, R0, S, ...U2, CS_P, R, S, U, S, R0, S, U0_LIF, S, R, C_P], // 14
    [Y0, S, U0_LIF, S, S_P, R0, S, ...U2, C_P, NL, S_P, R, S, U0_LIF, S, R0, S, U, S, R, C_P], // 15
    [Y0, S, S_P, R0, S, U, S, R, S, U0_RT, S, U0_LIF, C_P, NL, S_P, R0, S, U0_LIF, S, R, C_P], // 16
    ...
    [U0_LIF, S, S_P, R, S, U, S, R0, C_P, S, Y0, S, S_P, U, S, R0, S, U0_LIF, S, R, C_P], // 23
    [Y0, S, U, S, S_P, R0, S, U, S, R, S, U0_LIF, CS_P, R0, S, U0_LIF, S, R, C_P], // 24
    [Y0, S, S_P, R0, S, U0_LIF, S, R, C_P], // 25
    [Y0, S, U, S, S_P, R0, S, U0_LIF, S, R, S, U0_LIF, C_P, NL, S_P, R0, S, U0_LIF, S, R, C_P], // 26
    [Y0, S, S_P, R, S, U0_RT, S, U0_LIF, C_P, NL, S_P, ...R20, S, U0_LIF, CS_P, ...R2, S, U0_LIF, S, R0, C_P], // 27
    ...
    [Y0, S, U, S, S_P, R0, S, U0_LIF, S, R, C_P, S, DE0_RF, S_P, R, S, U, S, R0, C_P], // 33
    [Y0, S, U0_LIF, S, S_P, R0, S, U, S, R, C_P], // 34
    [Y0, S, U, S, S_P, R0, S, U0_LIF, S, R, S, U0_RT, S, U0_LIF, C_P, NL, S_P, R0, S, U, S, R, C_P], // 35
    [Y0, S, U, S, S_P, R0, S, ...U2, S, R, S, U0_RT, S, U0_LIF, C_P, NL, S_P, R0, S, U, S, R, C_P], // 36
    [S_P, R, S, U0_LIF, S, R0, S, ...U2, C_P, S, Y0, S, S_P, R0, S, U0_LIF, S, R, C_P], // 37
    ...
    [F, S, S_P, R, S, U0_LIF, S, R0, S, U0_LIF, CS_P, R, S, U, S, R0, S, F0_RT, C_P, NL, S_P, R, S, U, S, R0, S, U0_LIF, CS_P, R0, S, F, S, R, S, F0_RT, C_P], // 11
    [Z, S, S_P, U0_LIF, S, R, S, D0_RRF, CS_P, ...R2, S, U, S, R0, S, U0_LIF, C_P, NL, S_P, ...R2, S, U, CS_P, D_RRF, S, R0, C_P], // 12
    [S_P, R, S, U, S, R0, S, F0_RT, CS_P, R, S, U, S, R0, S, U0_LIF, C_P, NL, S_P, R0, S, F, CS_P, ...R2, S, U0_LIF, S, R0, S, U0_LIF, C_P], // 13
    [S_P, R0, S, ...U2, CS_P, R, S, U0_RT, S, U0_LIF, C_P, NL, S_P, R0, S, F, S, R, S, U, S, R0, S, U0_LIF, C_P, NL, S_P, R0, S, F0_RT, S, ...R2, S, U0_LIF, C_P], // 14
    [S_P, R, S, U0_LIF, S, R0, S, U0_LIF, CS_P, R, S, U, S, R, S, D_RRF, C_P, NL, S_P, R0, S, U0_LIF, S, R, S, D0_RRF, CS_P, R0, S, ...U2, S, R0, S, U0_LIF, C_P], // 15
    [S_P, ...R20, S, UE0_LIF, S, R, S, U0_RT, S, R, C_P, NL, S_P, U, S, R0, S, UE, CS_P, ...R2, S, FV, S, R0, S, FV0_RT, C_P], // 16
    [S_P, R, S, U, S, R0, C_P, S, Y0, S, S_P, ...R2, S, UE0_RT, S, R, S, U0_LIF, C_P, NL, S_P, R0, S, U, S, R0, S, UE, S, ...R2, C_P], // 17
    [S_P, ...R2, S, UE, S, R0, CS_P, U, S, R0, S, U0_LIF, S, R, S, UE0_LIF, C_P, NL, S_P, ...R2, S, F0_RT, S, U, S, F, C_P], // 18
    [S_P, R0, S, DE0_RF, S, F, CS_P, ...R2, S, UE, C_P, NL, S_P, R0, S, U, CS_P, R, S, U0_RT, S, R, S, UE0_LIF, S, ...R2, C_P], // 19
    [S_P, R0, S, U, S, R, S, U0_LIF, CS_P, R0, S, F0_RT, S, U0_LIF, C_P, NL, S_P, F, S, R, S, U, S, R0, S, F, C_P, NL, S_P, R0, S, F0_RT, S, R, S, U0_LIF, S, R, C_P], // 20
    [S_P, R, S, U, S, R0, S, U, CS_P, R, S, U, S, R0, S, F0_RT, C_P, NL, S_P, R, S, U, S, R0, S, U0_LIF, CS_P, R0, S, F, C_P, NL, S_P, ...R2, S, U0_LIF, S, R0, S, ...U2, CS_P, R, S, U0_LIF, S, R0, C_P], // 21
];
